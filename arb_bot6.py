...
"""
Funding Rate Arbitrage Bot — NAORIS-USDT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ИЗОЛЯЦИЯ ОТ SMC-БОТА (bot.py):
  ✓ Символ:    NAORIS-USDT (не входит в SYMBOLS бота)
  ✓ Стейт:     arb_state6.json  (бот пишет trades.json)
  ✓ Лог:       arb_bot6.log     (бот пишет bot.log)
...
STATE_FILE = f"{BOT_DIR}/arb_state6.json"   # НЕ trades.json !
LOG_FILE   = f"{BOT_DIR}/arb_bot6.log"      # НЕ bot.log !
...
def cmd_enter():
    ...
    import fcntl
    _lock_path = "/tmp/arb_bot6.enter.lock"
